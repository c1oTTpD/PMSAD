...
from lib_PMSAD.models.tools.module_helper import ModuleHelper
from lib_PMSAD.utils.tools.logger import Logger as Log
...
class HRNetBackbone(object):
    ...
    def __call__(self):
        ...
        from ProtoSeg.lib_PMSAD.models.backbones.hrnet.hrnet_config import MODEL_CONFIGS
